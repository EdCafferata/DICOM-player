...
- [ ] Golf 3 — ETHealthworld: eerst een echte gratis redactie-ingang vinden (status: zie regel verderop, laatst gecheckt 1 september 2026, nog steeds niets bruikbaars)
...
- [x] Onderzocht, nog geen bruikbaar contact — PGIMER Chandigarh en CMC Vellore — **achterhaald, beide inmiddels gemaild** (zie 380/381 hieronder: PGIMER via pgimer@chd.nic.in 4 augustus, CMC Vellore via radio@cmcvellore.ac.in 4 augustus)
- [ ] ETHealthworld — opnieuw gezocht (27 juli en 1 september 2026): nog steeds geen gratis redactie-ingang gevonden (alleen betaalde/commerciële content-routes zichtbaar). Blijft "on hold" tot een concreet redactioneel contact opduikt
